...
PUBLIC_DATA_BASE_URL = os.getenv(
    "JAPAN_POWER_PUBLIC_DATA_URL",
    "https://raw.githubusercontent.com/taiyu-wang/japan_power_trading_dashboard/data/data/published",
).rstrip("/")

PUBLISHED_ARTIFACTS = {
    "weather": "weather_temperatures.csv",
    "news": "power_news.csv",
    "jepx_spot_daily": "jepx_spot_daily.csv",
    "jepx_intraday": "jepx_intraday.csv",
    "jepx_baseload": "jepx_baseload.csv",
    "jepx_offer_stack_depth": "jepx_offer_stack_depth.csv",
    "jepx_offer_stack_curves": "jepx_offer_stack_curves.csv",
    "supply_mix": "supply_mix_monthly.csv",
    "supply_mix_daily_shape": "supply_mix_daily_shape.csv",
    "supply_mix_residual_thermal": "supply_mix_residual_thermal.csv",
}
...
WEATHER_SOURCE_NOTE = (
    "Default weather uses the scheduled Open-Meteo snapshot with bundled fallback; on-demand refresh re-queries Open-Meteo."
)
